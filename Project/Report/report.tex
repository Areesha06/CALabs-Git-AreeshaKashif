...
\begin{itemize}
\item Function calls using \texttt{jal}
\item Branching for loop termination
\item ALU-based decrement operations
\item Register file and stack for state preservation
\item Memory-mapped input/output for hardware interaction
\end{itemize}
...
% ==========================================================
\section{Task C: Program Description}
...
\item Return address (ra) is saved and restored
